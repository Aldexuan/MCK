...
* * 6是清除保存的所有蓝牙设备信息，如果总是连接不是可以把保存的蓝牙设备全清了，重新连接
* * 7是清除保存的当前连接的蓝牙设备信息，如果总是连接不是可以把这个设备的蓝牙记录清除，重新连接
* * 8是切换下一个蓝牙设备
* * 9是切换下一个蓝牙设备
...
* * 鼠标右键：&mkp RCLK
* * 鼠标中键：&mkp MCLK
* 轨迹球功能：在 config/boards/shields/keyball61/keyball61_right.overlay
